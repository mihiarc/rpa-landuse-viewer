...
def create_semantic_layers(args):
    ...
    from rpa_landuse_viewer.pandasai.layers import extract_data_from_duckdb, create_semantic_layers
    import os
...
def initialize_db(args):
    ...
    if args.import_data and args.data_path:
        from rpa_landuse_viewer.db.import_landuse_data import process_transitions
